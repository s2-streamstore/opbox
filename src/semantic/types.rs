...
pub enum SemanticRequest {
    ...
    /// Close an import epoch and ask Semantic what Engine should do next.
    CommitImportEpoch {
        epoch: ImportEpoch,
        reply: oneshot::Sender<eyre::Result<NextWork>>,
    },
    ...
    /// Close a projection epoch and ask Semantic what Engine should do next.
...
pub enum ProjectionEpochEndReason {
    PlanExhausted,
    ProjectionChanged { generation: ProjectionGeneration },
